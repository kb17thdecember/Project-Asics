    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('admin/home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Asics Admin</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('admin/home') }}">
                    ...
                    <span>Trang chủ-{{  Auth::user()->permission  }}</span></a>
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('admin/users') }}">
                    ...
                    <span>Tài khoản quản lý</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('admin/customers') }}">
                    <i class="fa-solid fa-user"></i>
                    <span>Tài khoản khách hàng</span></a>
            </li>
            <li class="nav-item active">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="{{ url('admin/notification') }}" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
