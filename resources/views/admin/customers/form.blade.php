                ...
                <div class="p-5">
                    <div class="text-center">
                        @php
                            ...
                            if($currentUri == "admin/customers/create")
                                $process = "Tạo mới";
                        @endphp
                    ...
                    <form class="user" method="post" action="{{ $action }}">
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-10 col-md-9 col-lg-7 mb-3 mb-sm-0">
                                <input type="text" name="address" class="form-control form-control-user" value="{{ isset($record->address)?$record->address:'' }}" placeholder="Địa chỉ" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-10 col-md-9 col-lg-7 mb-3 mb-sm-0">
                                <input type="text" name="phone" class="form-control form-control-user" value="{{ isset($record->phone)?$record->phone:'' }}" placeholder="Số điện thoại" required>
                            </div>
                        </div>
